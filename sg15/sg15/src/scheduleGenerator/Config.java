...
public class Config extends javax.swing.JFrame {
	...
	private void checkActionPerformed(java.awt.event.ActionEvent evt, int i) {                                            
        if(this.check[i].isSelected()) {
            ...
            this.jobList[i].setModel(this.models[0]);
            this.scrollPane[i].setViewportView(this.jobList[i]);

            this.jobName[i].setColumns(20);

            this.label[i].setText("Job Name:");

            this.addJob[i].setText("Add Job");
            this.i = i;
            this.addJob[i].addActionListener(new java.awt.event.ActionListener() {
                @Override
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    if(!Config.this.jobName[Config.this.i].getText().isEmpty()) {
                        Config.this.models[0].addElement(Config.this.jobName[Config.this.i].getText());
                        Config.this.jobList[Config.this.i].setModel(Config.this.models[Config.this.i]);
                        Config.this.jobName[Config.this.i].setText("");
                    }
                }
            });

            this.deleteJob[i].setText("Delete Job");
            this.deleteJob[i].addActionListener(new java.awt.event.ActionListener() {
                @Override
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    while(!Config.this.jobList[Config.this.i].isSelectionEmpty()) {
                        int n = Config.this.jobList[Config.this.i].getSelectedIndex();
                        Config.this.models[Config.this.i].remove(n);
                    }
                    
                }
            });

            javax.swing.GroupLayout sundayTabLayout = new javax.swing.GroupLayout(this.tab[i]);
            this.tab[i].setLayout(sundayTabLayout);
            sundayTabLayout.setHorizontalGroup(
                ...
                .addGroup(sundayTabLayout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(this.scrollPane[i], javax.swing.GroupLayout.PREFERRED_SIZE, 182, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(18, 18, 18)
                    .addGroup(sundayTabLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(sundayTabLayout.createSequentialGroup()
                            .addComponent(this.label[i])
                            .addGroup(sundayTabLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(sundayTabLayout.createSequentialGroup()
                                    .addGap(14, 14, 14)
                                    .addComponent(this.addJob[i]))
                                .addGroup(sundayTabLayout.createSequentialGroup()
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(this.jobName[i], javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addComponent(this.deleteJob[i]))
                    ...
                    .addGroup(sundayTabLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(sundayTabLayout.createSequentialGroup()
                            .addGroup(sundayTabLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(this.jobName[i], javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(this.label[i]))
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(this.addJob[i])
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(this.deleteJob[i]))
                        .addComponent(this.scrollPane[i], javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addContainerGap(25, Short.MAX_VALUE))
            );
            this.dayTabs.addTab(weekDays[i], this.tab[i]);
        } else {
            this.numSelected--;
            stretch();
            this.dayTabs.remove(this.tab[i]);
        }
	...
	*/
    ...
    private void nextButtonActionPerformed(java.awt.event.ActionEvent evt) {
    	...
    	for(int i=0; i<7; i++){
    		...
    		dotw.addAll(jobs);
        	days.add(new Day(weekDays[i],dotw));
    		}
    	}
    ...
    @SuppressWarnings("rawtypes")
	private javax.swing.JList[] jobList 			= new javax.swing.JList[7];
    private javax.swing.JTextField[] jobName 		= new javax.swing.JTextField[7];
    private javax.swing.JLabel[] label 				= new javax.swing.JLabel[7];
